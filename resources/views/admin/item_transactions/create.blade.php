...
@section('title', trans('item_transactions.create').' '.trans('item_transactions.model name'))
            ...
            <div class="col-md-9" style="@if (App::isLocale('ar')) float: right !important; @endif">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/item_transactions') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('admin.item_transactions.form', ['formMode' => 'create'])
